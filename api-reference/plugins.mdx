...
<Note>
  Source Contact us for XFileSharing Payment Mods.
</Note>
...
<Note>
  You can [download Woocommerce plugin here ⇒ Woo plugin](https://payblis.com/plugins/woocommerce/woo-payblis-1.2.0.zip)
</Note>
...
- Domain: [https://pay.payblis.com](https://pay.payblis.com)
