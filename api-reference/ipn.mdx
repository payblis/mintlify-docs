...
<Note>
  IPN TESTING : We send manualy IPN Notify to your IPN URL, when you have send your request for create order, please contact us in Télégram, we will send IPN Notify.
</Note>
