---
title: "Checkout mode"
description: "Processing Payments with our Payblis checkout"
---

The checkout Integration method uses a secure redirection flow that sends customers to the Payblis hosted checkout page, where payment is processed and the result is returned via callback URLs.
